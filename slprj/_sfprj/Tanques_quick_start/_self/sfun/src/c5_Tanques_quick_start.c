...
static const char * c5_debug_family_names[5] = { "nargin", "nargout", "matrix1",
  "matrix2", "y" };

static const char * c5_b_debug_family_names[5] = { "nargin", "nargout",
...
static real_T c5_emlrt_marshallIn(SFc5_Tanques_quick_startInstanceStruct
  *chartInstance, const mxArray *c5_y, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_Tanques_quick_startInstanceStruct
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_c_emlrt_marshallIn(SFc5_Tanques_quick_startInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[2]);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_d_emlrt_marshallIn(SFc5_Tanques_quick_startInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  real_T c5_y[2]);
...
static void c5_scalarEg(SFc5_Tanques_quick_startInstanceStruct *chartInstance);
static real_T c5_eml_xdotu(SFc5_Tanques_quick_startInstanceStruct *chartInstance,
  real_T c5_x[2], real_T c5_y[2]);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_e_emlrt_marshallIn(SFc5_Tanques_quick_startInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static uint8_T c5_g_emlrt_marshallIn(SFc5_Tanques_quick_startInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
  ...
  (SFc5_Tanques_quick_startInstanceStruct *chartInstance, const mxArray *c5_st)
{
  ...
  *c5_y = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)),
    "y");
  chartInstance->c5_is_active_c5_Tanques_quick_start = c5_f_emlrt_marshallIn
  ...
  (SFc5_Tanques_quick_startInstanceStruct *chartInstance)
{
  ...
  real_T c5_y;
  int32_T c5_i3;
  real_T c5_b_matrix1[2];
  int32_T c5_i4;
  real_T c5_b_matrix2[2];
  ...
  int32_T c5_i9;
  real_T *c5_b_y;
  real_T (*c5_c_matrix2)[2];
  real_T (*c5_c_matrix1)[2];
  c5_c_matrix2 = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
  c5_b_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_c_matrix1 = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i0 = 0; c5_i0 < 2; c5_i0++) {
    _SFD_DATA_RANGE_CHECK((*c5_c_matrix1)[c5_i0], 0U);
  }

  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i1 = 0; c5_i1 < 2; c5_i1++) {
    c5_matrix1[c5_i1] = (*c5_c_matrix1)[c5_i1];
  }

  for (c5_i2 = 0; c5_i2 < 2; c5_i2++) {
    c5_matrix2[c5_i2] = (*c5_c_matrix2)[c5_i2];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_matrix1, 2U, c5_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_matrix2, 3U, c5_b_sf_marshallOut);
  ...
  for (c5_i3 = 0; c5_i3 < 2; c5_i3++) {
    c5_b_matrix1[c5_i3] = c5_matrix1[c5_i3];
  }

  for (c5_i4 = 0; c5_i4 < 2; c5_i4++) {
    c5_b_matrix2[c5_i4] = c5_matrix2[c5_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_b_nargout, 1U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_b_matrix1, 2U, c5_c_sf_marshallOut,
    c5_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_b_matrix2, 3U, c5_b_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_y, 4U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  ...
  for (c5_i5 = 0; c5_i5 < 2; c5_i5++) {
    c5_a[c5_i5] = c5_b_matrix1[c5_i5];
  }

  for (c5_i6 = 0; c5_i6 < 2; c5_i6++) {
    c5_b[c5_i6] = c5_b_matrix2[c5_i6];
  }

  c5_scalarEg(chartInstance);
  for (c5_i7 = 0; c5_i7 < 2; c5_i7++) {
    c5_b_a[c5_i7] = c5_a[c5_i7];
  }

  for (c5_i8 = 0; c5_i8 < 2; c5_i8++) {
    c5_b_b[c5_i8] = c5_b[c5_i8];
  }

  c5_y = c5_eml_xdotu(chartInstance, c5_b_a, c5_b_b);
  _SFD_SCRIPT_CALL(0U, chartInstance->c5_sfEvent, -2);
  ...
  *c5_b_y = c5_y;
  ...
  for (c5_i9 = 0; c5_i9 < 2; c5_i9++) {
    _SFD_DATA_RANGE_CHECK((*c5_c_matrix2)[c5_i9], 2U);
  }
}
  ...
  *c5_inData)
{
  ...
  for (c5_i10 = 0; c5_i10 < 2; c5_i10++) {
    c5_b_inData[c5_i10] = (*(real_T (*)[2])c5_inData)[c5_i10];
  }
  ...
  *c5_inData)
{
  ...
  for (c5_i12 = 0; c5_i12 < 2; c5_i12++) {
    c5_b_inData[c5_i12] = (*(real_T (*)[2])c5_inData)[c5_i12];
  }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_Tanques_quick_startInstanceStruct *chartInstance;
  chartInstance = (SFc5_Tanques_quick_startInstanceStruct *)chartInstanceVoid;
  c5_matrix2 = sf_mex_dup(c5_mxArrayInData);
  c5_identifier = c5_varName;
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_matrix2), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_matrix2);
  for (c5_i15 = 0; c5_i15 < 2; c5_i15++) {
    (*(real_T (*)[2])c5_outData)[c5_i15] = c5_y[c5_i15];
  }
  ...
  real_T c5_y[2])
{
  ...
  int32_T c5_i16;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), c5_dv1, 1, 0, 0U, 1, 0U, 2, 1, 2);
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_Tanques_quick_startInstanceStruct *chartInstance;
  chartInstance = (SFc5_Tanques_quick_startInstanceStruct *)chartInstanceVoid;
  c5_matrix1 = sf_mex_dup(c5_mxArrayInData);
  c5_identifier = c5_varName;
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_matrix1), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_matrix1);
  for (c5_i17 = 0; c5_i17 < 2; c5_i17++) {
    (*(real_T (*)[2])c5_outData)[c5_i17] = c5_y[c5_i17];
  }
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("matrix_x_matrix"), "name",
                  "name", 0);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]C:/Users/Aluno IC/Documents/MATLAB/Projeto001/matrix_x_matrix.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1539014307U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m"),
                  "context", "context", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_xdotu"), "name", "name", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  real_T c5_x[2], real_T c5_y[2])
{
  ...
  for (c5_k = 1; c5_k < 3; c5_k++) {
    ...
    c5_d += c5_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c5_b_k), 1, 2, 1, 0) - 1] * c5_y[_SFD_EML_ARRAY_BOUNDS_CHECK("",
      (int32_T)_SFD_INTEGER_CHECK("", (real_T)c5_b_k), 1, 2, 1, 0) - 1];
  }
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c5_matrix1)[2];
          real_T (*c5_matrix2)[2];
          c5_matrix2 = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
          c5_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c5_matrix1 = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c5_matrix1);
          _SFD_SET_DATA_VALUE_PTR(1U, c5_y);
          _SFD_SET_DATA_VALUE_PTR(2U, *c5_matrix2);
        }
      }
    } else {
