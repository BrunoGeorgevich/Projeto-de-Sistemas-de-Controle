...
static void initialize_params_c4_Tanques_quick_start
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance);
static void enable_c4_Tanques_quick_start(SFc4_Tanques_quick_startInstanceStruct
  *chartInstance);
static void disable_c4_Tanques_quick_start
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_Tanques_quick_start
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Tanques_quick_start
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance);
static void set_sim_state_c4_Tanques_quick_start
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_Tanques_quick_start
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance);
  ...
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Tanques_quick_start = 0U;
}
  ...
  (SFc4_Tanques_quick_startInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Tanques_quick_start(chartInstance);
...
const mxArray *sf_c4_Tanques_quick_start_get_eml_resolved_functions_info(void)
{
...
mxArray *sf_c4_Tanques_quick_start_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_Tanques_quick_start_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_Tanques_quick_start(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_Tanques_quick_start\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Tanques_quick_start_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_Tanques_quick_startInstanceStruct *)
...
{
  chart_debug_initialization(((SFc4_Tanques_quick_startInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_Tanques_quick_start
    ((SFc4_Tanques_quick_startInstanceStruct*) chartInstanceVar);
  initialize_c4_Tanques_quick_start((SFc4_Tanques_quick_startInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_Tanques_quick_start(void *chartInstanceVar)
{
  enable_c4_Tanques_quick_start((SFc4_Tanques_quick_startInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_Tanques_quick_start(void *chartInstanceVar)
{
  disable_c4_Tanques_quick_start((SFc4_Tanques_quick_startInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_Tanques_quick_start(void *chartInstanceVar)
{
  sf_gateway_c4_Tanques_quick_start((SFc4_Tanques_quick_startInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_Tanques_quick_start(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_Tanques_quick_start
    ((SFc4_Tanques_quick_startInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_Tanques_quick_start();/* state var info */
...
extern void sf_internal_set_sim_state_c4_Tanques_quick_start(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_Tanques_quick_start();/* state var info */
  ...
  set_sim_state_c4_Tanques_quick_start((SFc4_Tanques_quick_startInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_Tanques_quick_start(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c4_Tanques_quick_start(S);
}

static void sf_opaque_set_sim_state_c4_Tanques_quick_start(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_Tanques_quick_start(S, st);
}

static void sf_opaque_terminate_c4_Tanques_quick_start(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_Tanques_quick_startInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_Tanques_quick_start((SFc4_Tanques_quick_startInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_Tanques_quick_start((SFc4_Tanques_quick_startInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Tanques_quick_start(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_Tanques_quick_start
      ((SFc4_Tanques_quick_startInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_Tanques_quick_start(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlStart_c4_Tanques_quick_start(SimStruct *S)
{
  SFc4_Tanques_quick_startInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_Tanques_quick_startInstanceStruct *)utMalloc(sizeof
    (SFc4_Tanques_quick_startInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_Tanques_quick_startInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_Tanques_quick_start;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Tanques_quick_start;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_Tanques_quick_start;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_Tanques_quick_start;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_Tanques_quick_start;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_Tanques_quick_start;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_Tanques_quick_start;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Tanques_quick_start;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Tanques_quick_start;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_Tanques_quick_start;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_Tanques_quick_start;
...
void c4_Tanques_quick_start_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Tanques_quick_start(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Tanques_quick_start(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Tanques_quick_start(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Tanques_quick_start_method_dispatcher.\n"
