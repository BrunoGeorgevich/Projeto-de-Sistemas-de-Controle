...
typedef struct {
  ...
  real_T *c8_integral_address;
  int32_T c8_integral_index;
  real_T *c8_pidPreviousTime_address;
  int32_T c8_pidPreviousTime_index;
  real_T *c8_previousError_address;
  int32_T c8_previousError_index;
