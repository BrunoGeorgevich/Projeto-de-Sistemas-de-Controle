  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% Tanques_quick_start_B.Integrator1
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% Tanques_quick_start_DW.OUTPUT_PWORK.LoggedData
	  ...
	  ;% Tanques_quick_start_DW.state_PWORK.LoggedData
  ...
  targMap.checksum0 = 2955033906;
  targMap.checksum1 = 1792975044;
  targMap.checksum2 = 3081495399;
  targMap.checksum3 = 2142205430;
