  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% Tanques_quick_start_B.GainError
	  section.data(4).logicalSrcIdx = 3;
	  ...
	  ;% Tanques_quick_start_B.MatrixofGainsL
	  section.data(35).logicalSrcIdx = 34;
	  section.data(35).dtTransOffset = 35;
	
	  ;% Tanques_quick_start_B.MatrixBDiscrete
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% Tanques_quick_start_DW.SinaldeSadadoSeguidordeRefernci.LoggedData
  ...
  targMap.checksum0 = 1984191458;
  targMap.checksum1 = 1566655758;
  targMap.checksum2 = 3235082960;
  targMap.checksum3 = 1968222549;
